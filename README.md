<div align="center">
  <img 
    ...
    src="https://i.ibb.co.com/xSTRcvNK/Anjum-Hamim-Prioty-2-3.png" />
</div>
...
|---------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|---------------------------------------------------|-----------------------------|------------------------------------------|
| **Work Sync**             | [GitHub](https://github.com/prioty-web/work-sync-client)                                              | [GitHub](https://github.com/prioty-web/work-sync-server.git)                                                                                            | [Live](https://work-sync.surge.sh/)               | Employee Management       | Accessible dashboard                    |
